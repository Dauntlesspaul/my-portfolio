    ...
    <div ref={sidebarRef} className="side-bar">
      <div className="container">
        <div className="search">
          <Paper
            component="form"
            sx={{ p: '2px 4px', display: 'flex', alignItems: 'center', width: '100%', background: 'rgb(207, 207, 207)' }}
          >
            <InputBase
        ...
        <p>I am open to frontend and backend web development roles, and collaborative projects</p>
        ...
        <hr className="seg_line2" />
          <Link  target="_blank" rel="noopener noreferrer" to="https://wa.link/6e51su">
          <div className="e-address">
